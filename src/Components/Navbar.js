    ...
    return(
        <div className="w-full flex justify-between 2xl:p-6 xl:p-5 bg-[#2B2B2B]">
            ...
            <div className="flex 2xl:gap-7 xl:gap-5 2xl:mr-10 xl:mr-10 ">
                ...
                <div className="flex gap-3 justify-center items-center px-7 text-white hover:scale-95 font-bold ease-out transition-all duration-300 cursor-pointer bg-[#A259FF] rounded-3xl">
