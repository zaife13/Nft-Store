...
const NftHighlight = () => {
  ...
  return (
    <>
      <div className="max-w-[1050px] m-auto  h-[650px] bg-nftImg bg-center bg-cover  ">
        <div className="bg-gradient-to-t from-purple-600 to-transparent h-[650px] border-2 border-transparent">
          <div className="flex flex-col md:flex-row  mt-[120px] mb-[60px] md:mt-[250px] lg:mt-[300px] mx-[30px] md:mx-[70px] lg:mx-[100px]">
